This file is for the information about code and files for the work done in the paper titled "Accelerated discovery of perovskite-based materials guided by machine learning techniques."

Information about the files: 

The supplementary materials folder contains the following files:

1. Seven Excel files for a total of 246820 prototype structures with material names and features for each material. (1-ABX3, 2-AB2X5, 3-A2BX6, 4-A3B2X9, 5-AB2X4, 6-A2BCX6, 7-A4BCX12)
...
9. Tolerance Factor for ABX3.py: python file for calculating tolerance factor for single perovskite structures.

10. Tolerance Factor for ABCX.py: python file for calculating tolerance factor for double perovskite structures.

11. FinalRegModel.sav: pickle file for a regression model to predict bandgap.
...
All other files in the folder have a self-explanatory filename.  
	

Usage: 

1. Each file can be run using any Python IDE. 
2. All codes are self-explanatory and need no change to predict and train. 
3. In the Python files for tolerance factor and bandgap prediction, the filename must be changed to predict any of the seven prototype structures files. 
